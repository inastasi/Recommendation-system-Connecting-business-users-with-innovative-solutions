...
file_handler = logging.FileHandler('V2D.log')
...
class V2D:
    ...
    def __init__(self, load_model_path, save_model_path, model_name, prj_docs, empl_docs,  train_flag, mode, vec_size, epochs, window_size, neg_sampling, 
                 sub_sampling, dbow_words):
